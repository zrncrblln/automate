      ...
      <div class="container mt-5">
        ...
        <form method="post" class="shadow p-3 mt-5 form-w" action="req/teacher-edit.php">
          ...
          <div class="mb-3">
            ...
            <input type="radio" value="Male" <?php if ($teacher['gender'] == 'Male')
              echo 'checked'; ?> name="gender"> Male
            &nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" value="Female" <?php if ($teacher['gender'] == 'Female')
          ...
          <div class="mb-3">
            ...
            <div class="row row-cols-5">
              ...
              foreach ($classes as $class) {
                ...
                ?>
                <div class="col">
                  <input type="checkbox" name="classes[]" <?php if ($checked)
                    echo "checked"; ?>
