      ...
      <div class="dashboard-container">
        ...
        <section class="page-header">
          <div class="header-content">
            ...
            <p class="header-subtitle">Manage grade levels and academic years</p>
          </div>
        </section>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="action-buttons">
                        <a href="grade-edit.php?grade_id=<?= $grade['grade_id'] ?>" class="btn-edit">Edit</a>
                        <a href="grade-delete.php?grade_id=<?= $grade['grade_id'] ?>" class="btn-delete">Delete</a>
                      </div>
                    </td>
                  </tr>
                <?php } ?>
